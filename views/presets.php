...
<div class="scwriter-tabs-header">
    <div class="scwriter-tabs-header-title --single">
        <h1><?php esc_html_e('SCwriter Presets', 'scwriter'); ?></h1>
    </div>
</div>
<div class="scwriter-padding-wrapper">
    ...
    <div class="scwriter-presets">
        <form action="" class="scwriter-presets-settings" method="POST">
            ...
            <input type="hidden" name="enable_preview_outline" value="0">
            <div class="scwriter-presets-row --hidden">
                ...
                <label class="scwriter-toggle">
                    <input type="checkbox" name="enable_preview_outline" id="enable_preview_outline" value="1">
                    <span></span>
                </label>
            </div>
